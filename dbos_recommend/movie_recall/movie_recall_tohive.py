from utils import RetToHive, m_spark, movie_recall_db, k, minDCS, m_topK, update_user_db, FilterRecall, Word2Vector, \
                    LatestFilterRecall
from movie_recall import BkmeansCossim, get_movie_recall
...
class SaveMovieRecall(object):
    ...
    def __init__(self, channel, cate_id):
        ...
        self.mf_recall = LatestFilterRecall(self.spark_app, cate_id)
    ...
    def save_movie_filter_version_recall(self):
        ...
        movie_recall_ret = self.f_recall.get_filter_version_recall(recall='movie')
