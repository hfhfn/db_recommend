...
if __name__ == '__main__':
    ...
    # 测试
    # train_df = u_spark.sql('select * from {}.cf_action_weight'.format('update_user'))\
    #                             .where('cate_id={}'.format(1969)).drop('cate_id')#.limit(1000)
    # train_df = train_df.toPandas()#.set_index('user_id')
    # print(train_df.head())
    # ItemSimilarity(train_df['movie_dict'], 'hkdhf')
    pass
