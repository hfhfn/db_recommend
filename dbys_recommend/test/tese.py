...
# spark.sql("select * from protrait.movie_feature").show(10, truncate=False)
# spark.sql("select * from protrait.textrank").show(10, truncate=False)

# count = spark.sql("select * from protrait.movie_feature").count()
# count2 = spark.sql("select * from protrait.movie_feature").dropna().count()
# print(count)
# print(count2)
