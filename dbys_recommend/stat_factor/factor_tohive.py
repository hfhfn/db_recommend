...
from stat_factor import get_movie_hot_sort, get_movie_hot_factor, get_movie_score_factor, get_movie_time, \
    get_movie_year_factor, get_user_history, get_action_stat, get_movie_num_factor, get_movie_type
...
def save_movie_type():
    # 保存影视 是否付费，时长，剧集信息
    movie_ret = get_movie_type()
    movie_table = 'movie_type_factor'
    RetToHive(spark_app, movie_ret, database_name, movie_table)
