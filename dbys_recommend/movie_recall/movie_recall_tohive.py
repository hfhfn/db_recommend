from utils import RetToHive, m_spark, movie_recall_db, m_topK, update_user_db, FilterRecall, Word2Vector, \
                    LatestFilterRecall
from movie_recall import LshSimilar, FaissSimilar
...
class SaveMovieRecall(object):
    ...
    def save_movie_recall(self):
        ...
        faiss_similar = FaissSimilar(self.cate_id)
        movie_recall_ret = faiss_similar.compute_movie_similar()
        movie_recall_table = 'movie_similar_{}'.format(self.cate_id)
