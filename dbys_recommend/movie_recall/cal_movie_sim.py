...
class LshSimilar(object):
    ...
    def fit_lsh(self, movieVector):
        ...
        # brp_model.transform(movieVector).show()
    ...
    def get_lsh_similar(self):
        ...
        similar = similar.withColumn("sort_num", fn.row_number().over(Window.partitionBy("movie_id")
...
if __name__ == '__main__':
    ...
    # movieVector = lsh_similar.load_movie_vector()
    # lsh_model = lsh_similar.fit_lsh(movieVector)
