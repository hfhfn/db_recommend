...
"""
#上线数据库
online_db = 'music_online'
# 电影原始数据库
movie_original_db = 'music'
# 用户原始数据库
user_original_db = 'music_userdata'
# 影响因子数据库
factor_db = 'music_factor'
# 用户数据预处理数据库
user_pre_db = 'music_pre_user'
# 基于电影增量更新数据库
update_movie_db = 'update_music'
# 基于用户增量更新数据库
update_user_db = 'music_update_user'
# 基于协同过滤数据库
als_db = 'music_als'
...
movie_model_path = 'hdfs://{}/music/models/'.format(hadoop_host)
# CountVectorizer模型保存位置
cv_path = "hdfs://hadoop-master:8020/music/models/CV.model"
# tfidf模型保存位置
idf_path = "hdfs://hadoop-master:8020/music/models/IDF.model"
...
"""
# 电影画像数据库
movie_portrait_db = 'music_portrait'
# 电影画像词数量
mf_topK = 30
...
"""
# 用户画像数据库
user_portrait_db = 'music_user_portrait'
# 电影画像词数量
uf_topK = 30
...
# 基于用户召回模块参数
"""
user_recall_db = 'music_user_recall'
