from user_portrait import merge_user_data, get_pre_table, pre_user_data
from utils import RetToHive, user_pre_db, user_portrait_db, u_spark
...
class SaveUserProfile(object):
    ...
    def save_user_profile(self):
        ...
        """
        topK = 30
        user_profile_ret = get_user_profile(self.portrait_db, topK)
