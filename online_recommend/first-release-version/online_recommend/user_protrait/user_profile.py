from utils import user_protrait_db, movie_protrait_db, UserDataApp
...
def get_action_weight(user_pre_db):
    ...
    movie_time = spark.sql("select * from {}.movie_time".format(movie_protrait_db))
...
def normal_action_weight(user_protrait_db):
    action_weight = spark.sql("select * from {}.action_weight".format(user_protrait_db))
    import pyspark.sql.functions as fn
...
def get_action_topic_weight(user_protrait_db):
...
def get_action_topic_sort(user_protrait_db):
    # action_topic_weight = get_action_topic_weight()
    action_topic_weight = spark.sql("select * from {}.action_topic_weight".format(user_protrait_db))
...
def get_user_profile(user_protrait_db, topK):
    action_topic_sort = spark.sql("select * from {}.action_topic_sort".format(user_protrait_db))
