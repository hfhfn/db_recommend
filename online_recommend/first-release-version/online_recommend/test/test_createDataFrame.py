...
from utils import MovieDataApp, RetToHive, user_pre_db
...
#     Row(user_id=1, movie_id=1, cate_id=1, weight=3, title=['美国·队长普通话版']),
#     Row(user_id=2, movie_id=1, cate_id=1, weight=5, title=['美国队长3普通话版']),
