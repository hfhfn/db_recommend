...
class RetToHive(object):
    ...
    def creat_database(self):
        ...
        # 创建数据库和表时， hive.sql 可以在创表语句末尾添加 location '/user/hive/warehouse/portrait.db'
        # 来定义hdfs中的位置和数据库/表名
...
# self.predata_sql = '''
        ...
        # # hive.sql中末尾可添加:  LOCATION '/user/hive/warehouse/portrait.db/movie_feature'
