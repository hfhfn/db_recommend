...
class BaseCutWords(object):
    ...
    def __init__(self, filter=True, stopwords=True):
        self.filter = filter
...
class UserFilterCutWords(BaseCutWords):
    """
    ...
    def get_words(self, sentence_df=None):
        ...
        """
        doc = sentence_df.rdd.mapPartitions(self.segmentation) \
            .toDF(["user_id", "movie_id", "cate_id", "weight", "title", "title_len", "words", "words_len"]).dropna()
        # print(doc.show())
        return doc
