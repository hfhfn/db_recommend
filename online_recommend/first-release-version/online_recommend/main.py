...
def user_profile_recall_run():
    save_inverted_table()  # 基于 topic_weights
    ur = SaveUserRecall()
...
def user_similar_recall_run():
    usr = SaveUserSimilarRecall()
