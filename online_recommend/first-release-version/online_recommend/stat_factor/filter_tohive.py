from utils import RetToHive, cate_id
...
from stat_factor import get_movie_hot_sort, get_movie_hot_factor, get_movie_score_factor, get_movie_time, \
    get_movie_year_factor, get_user_history
...
def save_movie_year_factor():
    # 保存电影年代衰减因子    300794
    year_factor_ret = get_movie_year_factor()
