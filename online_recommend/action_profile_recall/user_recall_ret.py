from utils.default import u_topK, pre_topK, factor_db, movie_portrait_db
...
class UserRecall(object):
    ...
    def get_user_recall_hot_score_year_factor(self):
        ...
        year_df = self.spark.sql('select * from {}.movie_year_factor'.format(self.movie_portrait_db))
