from movie_recall.cal_movie_sim import BkmeansCossim
from movie_recall.movie_filter_recall import MovieFilterRecall
from movie_recall.movie_recall_ret import get_movie_recall
from movie_recall.word2vec import Word2Vector
from utils.default import m_topK, minDCS, k, movie_recall_db, m_spark
...
class SaveMovieRecall(object):
    ...
    def __init__(self, channel, cate_id):
        ...
        self.mf_recall = MovieFilterRecall(self.spark_app, cate_id)
